		...
		<div class="wrapper theme-1-active pimary-color-red">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a class="active" href="add-storelogin.php">
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Add Store Login</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="admintable.php"><span>Store Login Table</span></a></li>
								<li class="active"><span>Add Store Login</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Add Store Login</h6>
									</div>
									<div class="clearfix"></div>
								</div>
