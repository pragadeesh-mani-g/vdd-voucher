...
function (a) {
	a.str = {}, a.str.contains = function (b, c, d) {
		...
		return !1
	}, a.str.from = function (a, b) {
		return this.contains(a, b) ? a.substring(a.indexOf(b) + 1) : a
	}, a.str.startsWith = function (a, b) {
		return a.slice(0, b.length) == b
	}, a.str.toCamelCase = function (a) {
		return a.toUpperCase() === a ? a.toLowerCase() : a.replace(/^([A-Z])|[-\s_](\w)/g, function (a, b, c) {
	...
	b.__extend__ = function (b, d, e, f) {
		...
		load: function (b, c) {
			var d = this,
				...
				f = [],
				g = [];
			for (var h in d.registered) d.registered.hasOwnProperty(h) && f.push(d.registered[h]);
			return f.sort(function (a, b) {
				return b.priority - a.priority
			}), a.arr.each(f, function (b) {
				a.is.fn(b.klass) && g.push(d._make(b.klass, e))
			}), g
		},
		make: function (b, c, d) {
			var e, f = this,
...
function (a, b) {
	b.css2json = function (c) {
		...
		for (var d, e, f, g = {}, h = c.split(";"), i = 0, j = h.length; j > i; i++) d = h[i].split(":"), e = b.str.toCamelCase(a.trim(d[0])), f = a.trim(d[1]), g[e] = f;
		return g
	}, b.getFnPointer = function (a) {
		return b.is.emptyString(a) ? null : b.is.fn(window[a]) ? window[a] : null
	...
	b.Row = b.Class.extend({
		...
		val: function (c, d) {
			...
			this.o = a.extend(!0, {
				...
				classes: e.classes,
				style: e.style
			}, g ? c.options : {}), this.expanded = this.o.expanded, this.classes = b.is.array(this.o.classes) ? this.o.classes : b.is.string(this.o.classes) ? this.o.classes.match(/\S+/g) : [], this.style = b.is.hash(this.o.style) ? this.o.style : b.is.string(this.o.style) ? b.css2json(this.o.style) : {}, this.value = f ? g ? c.value : c : null, b.arr.each(this.cells, function (a) {
...
function (a, b) {
	b.instances = [], b.Table = b.Class.extend({
		construct: function (c, d, e) {
			this._resizeTimeout = null, this.id = b.instances.push(this), this.initialized = !1, this.$el = (b.is.jq(c) ? c : a(c)).first(), this.o = a.extend(!0, {}, b.defaults, d), this.classes = [], this.components = {
				internal: b.components.internal.load(this),
				core: b.components.core.load(this),
				custom: b.components.load(this)
			}, this.breakpoints = this.use(FooTable.Breakpoints), this.columns = this.use(FooTable.Columns), this.rows = this.use(FooTable.Rows), this._construct(e)
		},
		...
		_preinit: function () {
			...
			return this.raise("preinit.ft.table").then(function () {
				var d = c.$el.attr("class").match(/\S+/g),
					e = c.$el.data() || {};
				c.o.ajax = b.checkFnValue(c, e.ajax, c.o.ajax), c.o.stopPropagation = b.is["boolean"](e.stopPropagation) ? e.stopPropagation : c.o.stopPropagation;
				for (var f = 0, g = d.length; g > f; f++) b.str.startsWith(d[f], "footable") || c.classes.push(d[f]);
				var h = a("<div/>", {
					"class": "footable-loader"
				}).append(a("<span/>", {
					"class": "fooicon fooicon-loader"
				}));
				return c.$el.hide().after(h), c.execute(!1, !1, "preinit", e).always(function () {
					c.$el.show(), h.remove()
				})
			})
		},
		...
		use: function (a) {
			for (var b = this.components.internal.concat(this.components.core, this.components.custom), c = 0, d = b.length; d > c; c++)
				if (b[c] instanceof a) return b[c];
			return null
		},
		draw: function () {
			var a = this;
			return a.execute(!1, !0, "predraw").then(function () {
		...
		execute: function (a, c, d, e, f) {
			...
			a = h.shift(), c = h.shift();
			var i = c ? b.arr.get(g.components.internal, function (a) {
					return a.enabled
				}) : g.components.internal.slice(0),
				j = c ? b.arr.get(g.components.core, function (a) {
					return a.enabled
				}) : g.components.core.slice(0),
				k = c ? b.arr.get(g.components.custom, function (a) {
					return a.enabled
				}) : g.components.custom.slice(0);
			return h.unshift(a ? k.reverse() : i), g._execute.apply(g, h).then(function () {
				return h.shift(), h.unshift(a ? j.reverse() : j), g._execute.apply(g, h).then(function () {
					return h.shift(), h.unshift(a ? i.reverse() : k), g._execute.apply(g, h)
				})
			})
		},
...
function (a, b) {
	b.Component = b.Class.extend({
		...
		draw: null,
		postdraw: null
	}), b.components = new b.ClassFactory, b.components.core = new b.ClassFactory, b.components.internal = new b.ClassFactory
}(jQuery, FooTable),
function (a, b) {
...
function (a, b) {
	...
	}), b.components.internal.register("breakpoints", b.Breakpoints, 10)
}(jQuery, FooTable),
function (a) {
...
function (a, b) {
	b.Columns = b.Component.extend({
		construct: function (a) {
			this._super(a, !0), this.o = a.o, this.array = [], this.$header = null, this.showHeader = a.o.showHeader
		},
		parse: function (c) {
			var d = this;
			return a.Deferred(function (c) {
				...
				if (0 == j.length && (j = d.ft.$el.find("thead > tr:last:has([data-breakpoints])")), 0 == j.length && (j = d.ft.$el.find("tbody > tr:first:has([data-breakpoints])")), j.length > 0) {
				...
				b.is.array(d.o.columns) ? (b.arr.each(d.o.columns, function (a, b) {
					a.index = b, h.push(a)
	...
	}), b.components.internal.register("columns", b.Columns, 5)
}(jQuery, FooTable),
function (a) {
...
function (a, b) {
	b.Rows = b.Component.extend({
		construct: function (a) {
			this._super(a, !0), this.o = a.o, this.array = [], this.all = [], this.showToggle = a.o.showToggle, this.toggleSelector = a.o.toggleSelector, this.toggleColumn = a.o.toggleColumn, this.emptyString = a.o.empty, this.expandFirst = a.o.expandFirst, this.expandAll = a.o.expandAll, this.$empty = null
		},
		parse: function () {
			var c = this;
			return a.Deferred(function (a) {
				var d = c.ft.$el.children("tbody").children("tr");
				b.is.jq(d) ? (c.parseFinalize(a, d), d.detach()) : b.is.array(c.o.rows) && c.o.rows.length > 0 ? c.parseFinalize(a, c.o.rows) : b.is.promise(c.o.rows) ? c.o.rows.then(function (b) {
					c.parseFinalize(a, b)
				}, function (b) {
	...
	}), b.components.internal.register("rows", b.Rows, 0)
}(jQuery, FooTable),
function (a) {
...
function (a) {
	a.Filter = a.Class.extend({
		construct: function (b, c, d, e, f, g) {
			this.name = b, this.space = !a.is.string(e) || "OR" != e && "AND" != e ? "AND" : e, this.connectors = a.is["boolean"](f) ? f : !0, this.ignoreCase = a.is["boolean"](g) ? g : !0, this.query = new a.Query(c, this.space, this.connectors, this.ignoreCase), this.columns = d
		},
		match: function (b) {
...
function (a, b) {
	b.Filtering = b.Component.extend({
		...
		$create: function () {
			...
			}).append(b.arr.map(d.ft.columns.array, function (b) {
			...
			})), d.delay > 0 && (d.$input.on("keypress keyup", {
				self: d
		...
		addFilter: function (a, c, d) {
			var e = b.arr.first(this.filters, function (b) {
				return b.name == a
			});
			e instanceof b.Filter ? (e.name = a, e.query = c, e.columns = d) : this.filters.push({
				name: a,
				query: c,
				columns: d
			})
		...
		filter: function (c, d) {
			return b.is.undef(c) ? c = a.trim(this.$input.val() || "") : this.$input.val(c), b.is.emptyString(c) ? this.removeFilter("search") : this.addFilter("search", c, d), this.$button.children(".fooicon").removeClass("fooicon-search").addClass("fooicon-remove"), this._filter()
		},
		clear: function () {
		...
		columns: function () {
			...
			return b.is.emptyArray(a) || b.arr.each(a, function (a) {
				b.is.object(a) && (!b.is.emptyString(a.query) || a.query instanceof b.Query) && (a.name = b.is.emptyString(a.name) ? "anon" : a.name, a.columns = b.is.emptyArray(a.columns) ? e : c.ft.columns.ensure(a.columns), d.push(a instanceof b.Filter ? a : new b.Filter(a.name, a.query, a.columns, c.space, c.connectors, c.ignoreCase)))
			}), d
		},
		_filter: function () {
			var a = this;
		...
		_onSearchInputChanged: function (a) {
			...
			(d || e) && (13 == a.which && a.preventDefault(), null != c._filterTimeout && clearTimeout(c._filterTimeout), c._filterTimeout = setTimeout(function () {
				c._filterTimeout = null, c.filter()
			}, c.delay))
		},
		_onSearchButtonClicked: function (a) {
			...
			c.hasClass("fooicon-remove") ? b.clear() : b.filter()
		},
		_onSearchColumnClicked: function (a) {
			...
			null != b._filterTimeout && clearTimeout(b._filterTimeout), b._filterTimeout = setTimeout(function () {
				...
				a.hasClass("fooicon-remove") && (a.removeClass("fooicon-remove").addClass("fooicon-search"), b.filter())
			}, b.delay)
		},
	...
	}), b.components.core.register("filtering", b.Filtering, 10)
}(jQuery, FooTable),
function (a) {
		...
		_match: function (b, c) {
			...
			return a.is.emptyArray(d.parts) && d.left instanceof a.Query ? c : a.is.emptyArray(d.parts) ? e : ("OR" === d.space ? a.arr.each(d.parts, function (c) {
				if (c.empty && f) {
					...
					var g = a.str.contains(b, c.query, d.ignoreCase);
...
function (a) {
	a.Table.prototype.applyFilter = function (b, c) {
		return this.use(a.Filtering).filter(b, c)
	}, a.Table.prototype.clearFilter = function () {
		return this.use(a.Filtering).clear()
	}
}(FooTable),
function (a, b) {
...
function (a, b) {
	b.Sorting = b.Component.extend({
		...
		destroy: function () {
			...
			this.ft.raise("destroy.ft.paging").then(function () {
				a.ft.$el.off("click.footable", ".footable-sortable", a._onSortClicked), a.ft.$el.children("thead").children("tr.footable-header").children(".footable-sortable").removeClass("footable-sortable").find("span.fooicon").remove()
			})
		},
		predraw: function () {
			if (this.column) {
	...
	}, b.components.core.register("sorting", b.Sorting, 5)
}(jQuery, FooTable),
function (a) {
...
function (a, b) {
	b.Paging = b.Component.extend({
		...
		$create: function () {
			...
			0 == c.length && (c = a("<tfoot/>"), this.ft.$el.append(c)), this.$row = a("<tr/>", {
				...
				"class": "divider"
			}), this.$count), this.detached = !1, this._createLinks()
		},
		first: function () {
			return this._set(1)
		},
	...
	}), b.components.core.register("paging", b.Paging, 0)
}(jQuery, FooTable),
function (a) {
...
function (a, b) {
	b.Editing = b.Component.extend({
		construct: function (c) {
			...
			}), this.position = c.o.editing.position, this.showText = c.o.editing.showText, this.hideText = c.o.editing.hideText, this.addText = c.o.editing.addText, this.editText = c.o.editing.editText, this.deleteText = c.o.editing.deleteText, this.callbacks = {
			...
			this.ft.raise("preinit.ft.editing", [c]).then(function () {
				if (d.ft.$el.hasClass("footable-editing") && (d.enabled = !0), d.enabled = b.is["boolean"](c.editing) ? c.editing : d.enabled, d.enabled) {
					...
					d.ft.columns.array.push(d.column), d.ft.columns.array.sort(function (a, b) {
						return a.index - b.index
					}), d.callbacks.addRow = b.checkFnValue(d, c.editingAddRow, d.callbacks.addRow), d.callbacks.editRow = b.checkFnValue(d, c.editingEditRow, d.callbacks.editRow), d.callbacks.deleteRow = b.checkFnValue(d, c.editingDeleteRow, d.callbacks.deleteRow)
				}
			}, function () {
				d.enabled = !1
			})
		...
		destroy: function () {
			...
			this.ft.raise("destroy.ft.editing").then(function () {
				a.ft.$el.removeClass("footable-editing").off("click.ft.editing").find("tfoot > tr.footable-editing").remove()
			})
		},
		$create: function () {
			var b = this,
			...
			b.ft.$el.addClass("footable-editing").addClass(c).on("click.ft.editing", ".footable-show", {
				...
				self: b
			}, b._onDeleteClick).on("click.ft.editing", ".footable-add", {
				self: b
			}, b._onAddClick), b.$cell = a("<td/>").attr("colspan", b.ft.columns.visibleColspan).append(b.$buttonShow()).append(b.$buttonAdd()).append(b.$buttonHide()), b.alwaysShow && b.ft.$el.addClass("footable-editing-always-show");
		...
		$rowButtons: function () {
			return a('<div class="btn-group btn-group-xs" role="group"></div>').append(this.$buttonEdit()).append(this.$buttonDelete())
		},
		draw: function () {
			this.$cell.attr("colspan", this.ft.columns.visibleColspan)
		},
	...
	}), b.components.internal.register("editing", b.Editing, 4)
}(jQuery, FooTable),
function (a, b) {
