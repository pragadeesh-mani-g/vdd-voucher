												...
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															...
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#01c853"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#fec107"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#ff2a00"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#2879ff"/>
															<input type="checkbox" checked class="js-switch js-switch-1" data-color="#e91e63"/>
														</div>
													</div>
												</div>
											</form>
										...
										<div class="form-wrap">
											<form>
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#e91e63" data-size="small"/>
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#ff2a00"/>
															<input type="checkbox" checked class="js-switch js-switch-1"  data-color="#01c853" data-size="large"/>
														</div>
													</div>
												</div>
											</form>
										...
										<div class="form-wrap">
											<form>
												<div class="row">
													<div class="col-lg-12">
														<div class="mt-25">
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#e91e63" data-secondary-color="#ff2a00" />
															<input type="checkbox" class="js-switch js-switch-1"  data-color="#ff2a00"  data-secondary-color="#e91e63" />
														</div>
													</div>
												</div>
											</form>
